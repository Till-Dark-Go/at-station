	...
	const handleLogIn = async () => {
		...
		try {
			...
			if (err.code === "auth/invalid-credential") {
				...
				setError(
					"An account already exists with this email using a different login method. Try logging in with the original provider.",
				);
	...
	return (
		<div className="main-block">
			...
			<div className="redirection-text">
				...
				<Link to="/home/sign-up" className="redirection-text-button">
					Sign up
				</Link>
			</div>
				...
				<div className="inputs-holder">
					<div className="entry-area">
						<input
							...
							required
						/>
						<label htmlFor="login-email" className="label-line">
							Email
						</label>
					</div>
					...
					<div className="entry-area">
						<input
							...
							required
						/>
						<label htmlFor="login-password" className="label-line">
							Password
						</label>
