  ...
  function nextStationInfo() {
    return (
      <div className="info">
        ...
        {props.timeAndCoords.hours > 0 && (
          <div className="travel-time">
            The road will take{" "}
            <strong>
              {props.timeAndCoords.hours} hr {props.timeAndCoords.minutes} min
            </strong>
          </div>
        )}
        {props.timeAndCoords.hours == 0 && (
          <div className="travel-time">
            The road will take{" "}
            <strong>{props.timeAndCoords.minutes} min</strong>
          </div>
        )}
    ...
    return (
      <div className="info">
        ...
        <div className="description">
          By clicking the button below, the travelling time will reset and you
          will be back at your starting station. Are you sure you want to
          proceed?
        </div>
      </div>
    );
