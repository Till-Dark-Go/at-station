...
import hovered_marker_logo from "../../assets/images/hovered_marker.svg";
        ...
        mapRef.current.loadImage(train_icon, (error, image) => {
            ...
            mapRef.current.addSource("moving-marker", {
                ...
                data: {
                    ...
                    geometry: {
                    type: "Point",
                    coordinates: [userStartingPoint.lng, userStartingPoint.lat],
                    },
                },
            });
    ...
    useEffect(() => {
        ...
        markersRef.current.forEach(({ marker, station }) => {
            ...
            if (isUserMarker) {
                ...
                marker_img.onclick = () => {
                    marker_img.src = hovered_marker_logo;
                        openPopup(hoverResults.hoursVar, hoverResults.minutesVar, hoverResults.nextLngVar, hoverResults.nextLatVar, station.id);
